...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cc_courses', '0071_alter_activity_minors_participants_number'),
        ('dataexports', '0022_data_services'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='activity',
            name='subsubservice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='dataexports.subsubservice', verbose_name='actuació'),
        ),
        migrations.AlterField(
            model_name='activity',
            name='service',
            field=models.SmallIntegerField(blank=True, choices=[(None, 'Cap'), (10, '1) Mapeig i diagnosi'), (20, '2) Divulgació, sensibilització i generació coneixement'), (30, '3) Formació per a la promoció, creació i consolidació '), (40, '4) Acompanyament per a la creació i consolidació '), (50, '5) Facilitació intercooperació, treball en xarxa i dinamització territori'), (60, "6) Punt d'informació sobre ESS"), (70, '7) Serveis Complementaris')], null=True, verbose_name='(OBSOLET) Servei'),
        ),
        migrations.AlterField(
            model_name='activity',
            name='sub_service',
