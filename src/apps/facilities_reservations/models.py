...
class Reservation(models.Model):
    ...
    responsible = models.ForeignKey(
        ...
        related_name='reservations',
        help_text="Persona de l'equip al càrrec de la reserva. Per aparèixer "
    ...
    url = models.CharField(
        ...
        null=True,
        max_length=250,
        help_text="En cas d'indicar-se, l'esdeveniment del calendari podrà "
        "clicar-se i portarà cap a aquest enllaç.",
    )
